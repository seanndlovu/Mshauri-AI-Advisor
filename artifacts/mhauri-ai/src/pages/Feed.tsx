...
function AwarenessStrip({
  ...
  const cards = [
    /* Ask Mshauri on WhatsApp */
    <a key="whatsapp" href={WA_LINK} target="_blank" rel="noreferrer"
      className="shrink-0 w-52 bg-[#16181C] border border-[#25d366]/40 border-l-2 border-l-[#25d366] rounded-2xl p-3.5 flex flex-col justify-between h-[90px] hover:bg-[#25d366]/5 transition-colors"
    >
      <div className="flex items-center gap-2">
        <div className="w-6 h-6 rounded-full bg-[#25d366] flex items-center justify-center shrink-0">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{width:"13px",height:"13px",fill:"white"}}>
        ...
        <div className="text-[#E7E9EA] font-bold text-[13px] leading-tight">Ask Mshauri</div>
      </div>
      <div className="text-[#71767B] text-[10px] leading-snug">Crop advice, prices & pests on WhatsApp</div>
      <div className="text-[#25d366] text-[10px] font-semibold">Chat now →</div>
    </a>,
